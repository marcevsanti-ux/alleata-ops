...
### Gemini API
- **Key mobile (portal-alleata-3):** [GEMINI_KEY_ROTAR_Y_REEMPLAZAR] — llamada directa sin proxy
- **Key desktop (portal-alleata-mobile):** [GEMINI_KEY_ROTAR_Y_REEMPLAZAR] — via proxy Supabase
- **Modelo:** gemini-2.5-flash
- **Proxy URL:** https://njkstpfmcfhqxdadqbdy.supabase.co/functions/v1/gemini-proxy
- **Secret Supabase:** `GEMINI_KEY=[GEMINI_KEY_ROTAR_Y_REEMPLAZAR]`
